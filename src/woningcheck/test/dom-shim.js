...
/**
 * Minimale nabootsing van een browser, genoeg om assets/woningcheck.js echt uit
...
/**
 * Voert assets/woningcheck.js uit in de nabootsing.
 * @param {object} opties
...
function laadClient(opties = {}) {
  ...
  const window = {
    ...
    devicePixelRatio: 1,
    WONINGCHECK: { basisPad: '/woningcheck', assetVersie: 'test' },
    navigator: {
  ...
  const bron = fs.readFileSync(path.join(__dirname, '..', 'assets', 'woningcheck.js'), 'utf8');

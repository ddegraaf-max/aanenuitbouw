...
const { parseCptXml } = require('../src/services/cptParser');
const { rdToWgs84, wgs84ToRd, afstandMeter } = require('../src/services/rd');
const { interpreteerSondering, classificeer, _intern } = require('../src/services/interpret');
const { _intern: broIntern } = require('../src/services/broClient');
const mock = require('../src/services/mockBro');
